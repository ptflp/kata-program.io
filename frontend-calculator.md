...
- Можно пользоваться гуглом, но не ищи готовое решение задачи. <br /><br />

## Как отправить решение?
Решение сохраняется на платформе под уникальным url. После решения задачи, сохраните ссылку на решение (скопировать url) и отправьте её нам на почту *info@kata.academy* с темой **"Тестовое задание Front-end"**
